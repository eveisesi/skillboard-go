CREATE TABLE `character_attributes` (
    ...
    CONSTRAINT `character_skill_attributes_character_id_foreign` FOREIGN KEY (`character_id`) REFERENCES `skillz`.`users` (`character_id`) ON UPDATE CASCADE ON DELETE CASCADE
